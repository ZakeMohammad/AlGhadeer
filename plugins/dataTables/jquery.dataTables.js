...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "لا يوجد صفوف بالداتا بيز"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "لا يوجد صفوف بالداتا بيز",
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "لا يوجد اي صف"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfoEmpty":  "لا يوجد اي صف",
	...
	"sInfoFiltered": "",
			 ...
			 *    } );
			 */
			"sZeroRecords": "لا يوجد صفوف تطابق البحث"
		},
